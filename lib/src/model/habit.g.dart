...
import 'habit_frequency.g.dart';
import 'habit_reminder.dart';
import 'habit_reminder.g.dart';
...
const HabitSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'reminder': PropertySchema(
      ...
      target: r'HabitReminder',
    ),
    r'state': PropertySchema(
      id: 6,
      name: r'state',
      type: IsarType.string,
      enumMap: _HabitstateEnumValueMap,
    )
  },
...
void _habitSerialize(
  ...
  writer.writeString(offsets[0], object.color.key);
  writer.writeObject<HabitFrequency>(
    offsets[1],
    allOffsets,
    HabitFrequencySchema.serialize,
    object.frequency,
  );
  writer.writeBool(offsets[2], object.isArchived);
  writer.writeBool(offsets[3], object.isEnabled);
  writer.writeString(offsets[4], object.name);
  writer.writeObjectList<HabitReminder>(
    offsets[5],
    allOffsets,
    HabitReminderSchema.serialize,
    object.reminder,
  );
  writer.writeString(offsets[6], object.state.key);
}
...
Habit _habitDeserialize(
  ...
  final object = Habit(
    ...
    id: id,
    reminder: reader.readObjectList<HabitReminder>(
          offsets[5],
          HabitReminderSchema.deserialize,
          allOffsets,
          HabitReminder(),
        ) ??
        const [],
...
P _habitDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 5:
      return (reader.readObjectList<HabitReminder>(
            offset,
            HabitReminderSchema.deserialize,
            allOffsets,
            HabitReminder(),
...
const _HabitcolorEnumValueMap = {
  ...
  r'pink': r'pink',
  r'purple': r'purple',
  r'darkGreen': r'darkGreen',
  r'lightGreen': r'lightGreen',
  r'darkBlue': r'darkBlue',
  r'lightBlue': r'lightBlue',
  r'brown': r'brown',
};
const _HabitcolorValueEnumMap = {
  ...
  r'darkGreen': HabitColor.darkGreen,
  r'lightGreen': HabitColor.lightGreen,
  r'darkBlue': HabitColor.darkBlue,
  r'lightBlue': HabitColor.lightBlue,
  r'brown': HabitColor.brown,
};
const _HabitstateEnumValueMap = {
  r'enabled': r'enabled',
  r'archieved': r'archieved',
};
const _HabitstateValueEnumMap = {
  r'enabled': HabitState.enabled,
  r'archieved': HabitState.archieved,
};
...
extension HabitQueryWhereSort on QueryBuilder<Habit, Habit, QWhere> {
  ...
  QueryBuilder<Habit, Habit, QAfterWhere> anyName() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitQueryWhere on QueryBuilder<Habit, Habit, QWhereClause> {
  ...
  QueryBuilder<Habit, Habit, QAfterWhereClause> nameEqualTo(String name) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterWhereClause> nameNotEqualTo(String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Habit, Habit, QAfterWhereClause> nameGreaterThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterWhereClause> nameLessThan(
    String name, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterWhereClause> nameBetween(
    String lowerName,
    String upperName, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterWhereClause> nameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'name',
        value: [''],
  ...
  QueryBuilder<Habit, Habit, QAfterWhereClause> nameIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> reminderLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> reminderLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> reminderLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> stateEqualTo(
    HabitState value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> stateGreaterThan(
    HabitState value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> stateLessThan(
    HabitState value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> stateBetween(
    HabitState lower,
    HabitState upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> stateStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> stateEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> stateIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'state',
        value: '',
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> stateIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'state',
        value: '',
...
extension HabitQuerySortBy on QueryBuilder<Habit, Habit, QSortBy> {
  ...
  QueryBuilder<Habit, Habit, QAfterSortBy> sortByIsEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEnabled', Sort.asc);
    });
  }

  QueryBuilder<Habit, Habit, QAfterSortBy> sortByIsEnabledDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterSortBy> sortByState() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'state', Sort.asc);
    });
  }

  QueryBuilder<Habit, Habit, QAfterSortBy> sortByStateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitQuerySortThenBy on QueryBuilder<Habit, Habit, QSortThenBy> {
  ...
  QueryBuilder<Habit, Habit, QAfterSortBy> thenByIsEnabled() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEnabled', Sort.asc);
    });
  }

  QueryBuilder<Habit, Habit, QAfterSortBy> thenByIsEnabledDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEnabled', Sort.desc);
    });
  }
  ...
  QueryBuilder<Habit, Habit, QAfterSortBy> thenByState() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'state', Sort.asc);
    });
  }

  QueryBuilder<Habit, Habit, QAfterSortBy> thenByStateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'state', Sort.desc);
    });
  }
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  ...
  QueryBuilder<Habit, Habit, QDistinct> distinctByIsEnabled() {
    return QueryBuilder.apply(this, (query) {
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, bool, QQueryOperations> isEnabledProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, HabitState, QQueryOperations> stateProperty() {
    return QueryBuilder.apply(this, (query) {
